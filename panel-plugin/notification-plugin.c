                                     ...
                                     NotificationPlugin *notification_plugin)
{
    ...
    success = xfce_notify_org_xfce_notifyd_log_call_has_unread_finish(XFCE_NOTIFY_ORG_XFCE_NOTIFYD_LOG(source),
                                                                      &has_unread,
                                                                      res,
                                                                      &error);
...
notification_plugin_log_changed(NotificationPlugin *notification_plugin) {
  xfce_notify_org_xfce_notifyd_log_call_has_unread(notification_plugin->log,
                                                   NULL,
                                        ...
                                        NotificationPlugin *notification_plugin)
{
  ...
  notification_plugin->log = xfce_notify_org_xfce_notifyd_log_proxy_new_finish(res, &error);
                                  ...
                                  NotificationPlugin *notification_plugin)
{
  ...
  if (G_UNLIKELY(notification_plugin->gbus == NULL)) {
    ...
    xfce_notify_org_xfce_notifyd_log_proxy_new(notification_plugin->gbus,
                                               0,
                                               "org.xfce.Notifyd",
                                               "/org/xfce/Notifyd",
                                               NULL,
