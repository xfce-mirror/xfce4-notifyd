    ...
    if(!strcmp(property, "/expire-timeout")) {
       ...
       xndaemon->do_slideout = G_VALUE_TYPE(value)
        ...
        xndaemon->do_not_disturb = G_VALUE_TYPE(value)
                                 ? g_value_get_boolean(value)
                                 : FALSE;
    } else if(!strcmp(property, "/disable-clear-prompt")) {
        xndaemon->disable_clear_prompt = G_VALUE_TYPE(value)
                                 ? g_value_get_boolean(value)
                                 : FALSE;
                               	...
                               	GError **error)
{
    ...
    xndaemon->do_not_disturb = xfconf_channel_get_bool(xndaemon->settings,
                                                       "/do-not-disturb",
                                                       FALSE);
    xndaemon->disable_clear_prompt = xfconf_channel_get_bool(xndaemon->settings,
                                                             "/disable-clear-prompt",
                                                             FALSE);
