...
#define SHOW_NOTIFICATIONS_ON_MONITOR_PROP  "/show-notifications-on-monitor"
...
#define SHOW_NOTIFICATIONS_ON_MONITOR_DEFAULT "DisplayPort-0"
...
typedef enum {
    ...
    XFCE_NOTIFY_SHOW_ON_CHOOSE_MONITOR,
} XfceNotifyShowOn;
